...
% laguna del maule
% sphnam = '/Users/feigl/Documents/data/ALOS/T113/6450fbs/In5602_21035.old/psm_5602_21035_ort.pha'; % nrows =         2000; ncols =         1200; % Laguna del Maule
% phabig = read_pha(sphnam,1200);
% phasmall=phabig(1100:1499,300:699);
% imagesc(phasmall);axis equal
% write_pha('psm_5602_21035_ort_400x400.pha',phasmall);
...
grxnam = regexprep(regexprep(sphnam,'p(\w*)_','grx_'),'.pha','.i2','once');
grynam = regexprep(regexprep(sphnam,'p(\w*)_','gry_'),'.pha','.i2','once');
...
p(pbyte==0) = NaN;               % convert zeros to missing values, coded as NaN
q(qbyte==0) = NaN;
% p(pbyte==-128) = NaN;
% q(qbyte==-128) = NaN;
% p(pbyte== 127) = NaN;
